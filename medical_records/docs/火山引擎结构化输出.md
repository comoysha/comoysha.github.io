...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="ydwY8XeMn0"><RenderMd content={`\`\`\`Bash
...
<Tabs.TabPane title="Python" key="IFq7wSoovm"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="DbdJ32I02G"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="m4DDs6WT24"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="weSbipgW2J"><RenderMd content={`\`\`\`Python
import os
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="HrwwcAijAO"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/responses \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $ARK_API_KEY" \\
  -d '{
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="Wp1vXZYCqk"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
